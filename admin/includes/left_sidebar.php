<div class="left-side-bar">
		<div class="brand-logo">
			<a href="admin_dashboard.php">
				...
				<img src="../vendors/images/deskapp-logo-white-svg.JPEG" alt="" class="light-logo">
			</a>
			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="apply_leave.php">Schedule Leave</a></li>
							<li><a href="leaves.php">All Leave</a></li>
							<li><a href="pending_leave.php">Waiting Leave</a></li>
							<li><a href="approved_leave.php">Completed Leave</a></li>
					...
					<li>
						<a href="https://mmust.ac.ke/" class="dropdown-toggle no-arrow">
