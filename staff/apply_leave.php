...
<?php
	...
	elseif($leave_days <= 0)
	{
		...
		if($lastInsertId)
		{
			echo "<script>alert('Sheduling Leave was successful.');</script>";
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											...
											<input name="lastname" type="text" class="form-control" readonly required="true" autocomplete="off">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="apply" id="apply" data-toggle="modal">Shedule&nbsp;Leave</button>
											</div>
										</div>
									</div>
								</div>
